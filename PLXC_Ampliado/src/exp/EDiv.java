...
public class EDiv{
	...
	public Object iguales(Object a,Object b){
		...
		if(Generador.Tipo(a)=='F'){	
			...
			Generador.escribir(Generador.DIV,a.toString(),"r "+b.toString(),v.toString());
		}else{
		    	v=Generador.nuevaTemp('I');
			Generador.escribir(Generador.DIV,a.toString(),b.toString(),v.toString());
		}
		return v;
	}
	public Object diferentes(Object o1,Object o2){	
		...
		Generador.escribir(Generador.DIV,o1.toString(),"r "+v0.toString(),v.toString());
		return v;
	}
	public Object diferentesB(Object o1,Object o2){	
		...
		Generador.escribir(Generador.DIV,v0.toString(),"r "+o2.toString(),v.toString());
		return v;
	}
	public Object val(){
		return exp1;
