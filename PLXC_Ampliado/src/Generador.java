...
public class Generador {
	...
	public static final int IFNEQ=12;
	...
	public static char Tipo(Object o){
		...
		if(o.getClass().getName().equalsIgnoreCase("java.lang.double")){
			...
			Variable v=(Variable) o;
		   	return v.tipoVar();
		}else if(o.getClass().getName().equalsIgnoreCase("src.var.array")){		
			Array a=(Array) o;			
		   	return a.tipoVar();
	...
	public static void escribir(int operacion, Object arg1, Object arg2, Object res) {
		...
		switch(operacion) {
			...
			case RANGO:				
				...
				out.println(" if("+res+" < "+"0) goto "+arg1+";");
				out.println(" if("+r.tope()+" < "+res+") goto "+arg1+";");
				out.println(" if("+r.tope()+" == "+res+") goto "+arg1+";");
