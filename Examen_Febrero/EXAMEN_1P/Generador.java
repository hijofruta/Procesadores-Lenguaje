...
public class Generador {
	...
	public static void escribir(int operacion, Object arg1, Object arg2, Object res) {
		...
		switch(operacion) {
			case PRINT:
				if(Variables.TipoVariable(res)=='V'){ 	
				Variable r=(Variable) res;				
				out.println("  print "+r.nombreCompleto()+";");
...
/*una variable y un numero*/	}else{ 
					if(Variables.TipoVariable(arg1)=='F'){    
					    out.println("  "+z.nombreCompleto()+"="+y.nombreCompleto()+"+r "+arg1+";");
					}else{
					    out.println("  "+z.nombreCompleto()+"="+y.nombreCompleto()+"+"+arg1+";");
					}
				}
				break;
			case MENOS:
...
/*una variable y un numero*/	}else{ 
			...
			case IFEQ:
				...
				}else{	out.println("  if("+arg1+"=="+arg2+") goto "+z.nombreCompleto()+";");} 
				break;
			case IFLT:
				if(Variables.TipoVariable(arg1)=='V'){x=(Variable) arg1;}
				if(Variables.TipoVariable(arg2)=='V'){y=(Variable) arg2;}
